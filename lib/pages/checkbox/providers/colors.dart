...
class MultiColor with ChangeNotifier {
  ...
  inisialData() async {
    Uri url = Uri.parse(
        'https://http-req-e5967-default-rtdb.firebaseio.com/colors.json');
  ...
  Future<void> addColor(String title) async {
    Uri url = Uri.parse(
        'https://http-req-e5967-default-rtdb.firebaseio.com/colors.json');
  ...
  void deleteColor(String id) async {
    Uri url = Uri.parse(
        'https://http-req-e5967-default-rtdb.firebaseio.com/colors/$id.json');
